...
import com.abhay.crypto.core.ui.component.AddToFolderBottomSheet
import com.abhay.crypto.core.ui.component.CoinListItem
import com.abhay.crypto.core.ui.component.CreateFolderDialog
import com.abhay.crypto.core.ui.component.ErrorView
import com.abhay.crypto.core.ui.component.FolderItem
import com.abhay.crypto.core.ui.component.LoadingView
import com.abhay.crypto.core.ui.component.NetworkBanner
import com.abhay.crypto.core.ui.component.RemoveCoinDialog
import com.abhay.crypto.core.ui.component.RenameFolderDialog
import com.abhay.crypto.core.ui.theme.Dimens
import com.abhay.crypto.core.ui.theme.ScreenBackground
import com.abhay.crypto.feature.widget.api.WidgetContract
...
private fun WatchlistDialogs(
    ...
    dialogState.coinToRemove?.let { (coinId, folder) ->
        RemoveCoinDialog(
            ...
            onConfirm = {
                folder?.let {
                    onEvent(WatchlistUiEvent.RemoveBookmarkFromFolder(it.id, coinId))
                }
...
private fun requestPinWidget(context: Context, folderId: String) {
    ...
    val provider = ComponentName(context, WidgetContract.WIDGET_RECEIVER_CLASS)
    if (manager.isRequestPinAppWidgetSupported) {
        val callbackIntent = Intent().apply {
            component = ComponentName(context, WidgetContract.PIN_RECEIVER_CLASS)
            putExtra(WidgetContract.EXTRA_FOLDER_ID, folderId)
        }
...
private fun WatchlistList(
    ...
    LazyColumn(
        ...
        if (uiState.folders.isNotEmpty()) {
            ...
            item { Spacer(modifier = Modifier.height(Dimens.SpacingSmall)) }
        }
